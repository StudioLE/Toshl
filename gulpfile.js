...
gulp.task('assets', function() {
  ...
  .pipe(gulp.dest(build.path('views/pages')))
  // Open Sans
...
gulp.task('css', function() {
  ...
  .pipe(gp_less({ paths: [
    'src/bower_components/bootswatch-dist/less/mixins.less',
    'src/bower_components/bootswatch-dist/less/variables.less'
  ]}))
...
gulp.task('vendor-js', function() {
  gulp.src([
    ...
    'src/bower_components/papaparse/papaparse.min.js',
    'src/bower_components/query-string/query-string.js',
    'src/bower_components/angular-oauth2/dist/angular-oauth2.min.js'
  ])
  .pipe(gp_concat('concat.js'))
